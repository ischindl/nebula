...
import org.eclipse.nebula.widgets.tablecombo.CheckBoxTableCombo;
...
public class CheckBoxTableComboViewer extends AbstractTableViewer {
	private CheckBoxTableCombo tableCombo;
	...
	public CheckBoxTableComboViewer(Composite parent, int style) {
		this(new CheckBoxTableCombo(parent, style));
	}
	 ...
	 * 		the table control
	 */
	public CheckBoxTableComboViewer(CheckBoxTableCombo tableCombo) {
	 ...
	 * @return
	 */
	public CheckBoxTableCombo getTableCombo() {
		return tableCombo;
	}
