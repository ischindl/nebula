...
public final class GridViewerColumn extends ViewerColumn
{
     ...
     * @param column
     */
    public GridViewerColumn(ColumnViewer viewer, GridColumn column) {
    	super(viewer, column);
    	this.viewer = viewer;
        this.column = column;
        ...
        if (columnResizeListener == null)
        {
            columnResizeListener = new Listener() {
                public void handleEvent(Event event)
                {
                    ...
                    if(viewer instanceof IGridViewer)
                    	autoPreferredSize = ((IGridViewer)viewer).getAutoPreferredHeight();
